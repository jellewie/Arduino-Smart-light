...
#define LEDSections TotalLEDs / 60                              //Amount of sections of LEDs for the Clock (2=each step is 2 LEDs so 12h=120+121 LED, 1=Default 12h=60th LED)const byte TotalLEDsClock = LEDSections * 60;
const byte TotalLEDsClock = LEDSections * 60;                   //The amount of LEDs in the clock
